...
namespace StandardPokerHandEvaluator
{
    ...
    public class Card
    {
        ...
        {
            string value = cardString[0].ToString();
            string suit = cardString[1].ToString();
            CardEnum cardEnum = StringValueToEnum(value);
            SuitEnum cardSuit = StringSuitToEnum(suit);
    ...
    public class TexasHand
    {
        private Card mC1;
        private Card mC2;
        public TexasHand(Card C1, Card C2)
        {
            this.mC1 = C1;
            this.mC2 = C2;
        }
        ...
        public List<Card> getCards()
        {
            ...
            totalCardsList.Add(mC1);
            totalCardsList.Add(mC2);
            return totalCardsList;
        }

        public String Tostring()
        {
            return mC1.ToString() + " " + mC2.ToString();
        }
    }
    public class BoardCards
    {
        private Card mC1 ,mC2,mC3,mC4,mC5;
        public BoardCards(Card C1, Card C2, Card C3, Card C4, Card C5)
        {
            this.mC1 = C1;
            this.mC2 = C2;
            this.mC3 = C3;
        ...
        public BoardCards(Card C1, Card C2, Card C3)
        {
            this.mC1 = C1;
            this.mC2 = C2;
            this.mC3 = C3;
        ...
        public List<Card> getCards()
        {
            ...
            totalCardsList.Add(mC1);
            totalCardsList.Add(mC2);
            totalCardsList.Add(mC3);
            totalCardsList.Add(mC4);
            totalCardsList.Add(mC5);
            return totalCardsList;
        }
