Shader "AllIn1SpriteShader/AllIn1Urp2dRenderer"
{
    Properties
    {
		...
		[HideInInspector] _MinXUV("_MinXUV", Range(0, 1)) = 0.0 //147
		...
		[HideInInspector] _RandomSeed("_MaxYUV", Range(0, 10000)) = 0.0 //151

		_MaskTex("Lighting Mask", 2D) = "white" {} //152
		_LitAmount("Lit Amount",  Range(0,1)) = 1 //153
		_NormalMap("Normal Map", 2D) = "bump" {} //154
		_NormalStrength("Normal Strength",  Range(0,10)) = 1 //155
		[Toggle()] _GlowAffectLight("Glow affects light", Float) = 1 //156
    }
